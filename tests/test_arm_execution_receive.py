...
@pytest.mark.parametrize(
    ...
    [
        ...
        _damaged_verification(1, is_grasped=1),
        _damaged_verification(1, is_grasped=0),
        _damaged_verification(1, is_grasped=None),
        _damaged_verification(1, confidence=True),
        _damaged_verification(1, confidence=False),
        _damaged_verification(1, confidence="0.9"),
        _damaged_verification(1, confidence=None),
        ...
        _damaged_verification(1, confidence=10 ** 1_000),
        _damaged_verification(1, visual_evidence=None),
        _damaged_verification(1, visual_evidence=123),
        _damaged_verification(1, effort_evidence=123),
        _damaged_verification(1, effort_evidence=None),
    ],
)
